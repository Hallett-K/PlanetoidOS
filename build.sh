...
i686-elf-gcc -g -c "$DEV_BOOT_DIR/kernel.c" -o "$KERNEL_OBJ" -std=gnu99 -ffreestanding -O0 -Wall -Wextra

i686-elf-gcc -g -T "$DEV_BOOT_DIR/linker.ld" -o "PlanetoidOS.bin" -ffreestanding -O0 -nostdlib "$BOOT_OBJ" "$KERNEL_OBJ" -lgcc
